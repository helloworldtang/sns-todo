...
public class Swagger2Config {
    ...
    public Docket docket() {
        return new Docket(DocumentationType.SWAGGER_2)//Docket, Springfox’s, primary api configuration mechanism is initialized for swagger specification 2.0
                .groupName("todoList")//分组，在html页面展示时有用。启用group选项会更改api json的访问路径。可以在/swagger-resources中location字段中找到
                ...
                .apis(RequestHandlerSelectors.basePackage("com.tangcheng.zhiban.sns.todo.web"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("sns todo list")
                .description("For efficient work ")
                .termsOfServiceUrl("https://github.com/helloworldtang/sns-todo.git\n")//服务条款
                .version("1.0.0")//本次发布的版本
                .contact(new Contact("Tang.Cheng", "https://github.com/helloworldtang/sns-todo.git\n", "helloworld.tang@qq.com"))
                .build();
    }
